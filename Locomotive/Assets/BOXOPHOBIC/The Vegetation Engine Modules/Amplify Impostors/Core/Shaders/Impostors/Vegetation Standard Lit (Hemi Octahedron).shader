    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            GraphVertexOutput vert (GraphVertexInput v)
        	{
				...
				float3 temp_output_3563_0_g52212 = worldPosOut99;
				float3 worldToObj3565_g52212 = mul( GetWorldToObjectMatrix(), float4( temp_output_3563_0_g52212, 1 ) ).xyz;
				float3 VertexPosition3564_g52212 = worldToObj3565_g52212;
				half3 VertexPos40_g53462 = VertexPosition3564_g52212;
				...
				float Motion_Max_Bending1133_g52212 = 3.14;
				...
				float3 ObjectPosition4422_g52212 = temp_output_114_0_g53480;
				float3 Position83_g53471 = ObjectPosition4422_g52212;
				...
				half4 Global_Motion_Params4344_g52212 = lerpResult87_g53471;
				float4 break322_g53478 = Global_Motion_Params4344_g52212;
				half Wind_Power369_g53478 = break322_g53478.z;
				float lerpResult376_g53478 = lerp( 0.1 , 1.0 , Wind_Power369_g53478);
				half Wind_Power_103106_g52212 = lerpResult376_g53478;
				...
				half2 Wind_DirectionOS39_g52212 = (temp_output_339_0_g53478).xz;
				float2 panner73_g53468 = ( _TimeParameters.x * (TVE_NoiseParams).xy + ( (ObjectPosition4422_g52212).xz * TVE_NoiseParams.z ));
				...
				half Wind_Power2223_g52212 = Wind_Power369_g53478;
				float temp_output_167_0_g53468 = Wind_Power2223_g52212;
				...
				half Global_NoiseTex_R34_g52212 = break142_g53468.r;
				half Input_Speed62_g52213 = _MotionSpeed_10;
				float mulTime373_g52213 = _TimeParameters.x * Input_Speed62_g52213;
				half Motion_Variation284_g52213 = 0.0;
				float2 appendResult344_g52213 = (float2(ase_worldPos.x , ase_worldPos.z));
				float2 Motion_Scale287_g52213 = ( _MotionScale_10 * appendResult344_g52213 );
				half2 Sine_MinusOneToOne281_g52213 = sin( ( mulTime373_g52213 + Motion_Variation284_g52213 + Motion_Scale287_g52213 ) );
				float2 temp_cast_6 = (1.0).xx;
				half Input_Turbulence327_g52213 = Global_NoiseTex_R34_g52212;
				float2 lerpResult321_g52213 = lerp( Sine_MinusOneToOne281_g52213 , temp_cast_6 , Input_Turbulence327_g52213);
				half2 Motion_Bending2258_g52212 = ( ( _MotionAmplitude_10 * Motion_Max_Bending1133_g52212 ) * Wind_Power_103106_g52212 * Wind_DirectionOS39_g52212 * Global_NoiseTex_R34_g52212 * lerpResult321_g52213 );
				half Interaction_Amplitude4351_g52212 = _InteractionAmplitude;
				float3 Position83_g53477 = ObjectPosition4422_g52212;
				...
				half4 Global_React_Params4413_g52212 = lerpResult87_g53477;
				float4 break322_g53460 = Global_React_Params4413_g52212;
				half Interaction_Mask66_g52212 = break322_g53460.z;
				...
				half2 Interaction_DirectionOS4349_g52212 = (temp_output_339_0_g53460).xz;
				half2 Motion_Interaction53_g52212 = ( Interaction_Amplitude4351_g52212 * Motion_Max_Bending1133_g52212 * Interaction_Mask66_g52212 * Interaction_Mask66_g52212 * Interaction_DirectionOS4349_g52212 );
				float2 lerpResult109_g52212 = lerp( Motion_Bending2258_g52212 , Motion_Interaction53_g52212 , ( Interaction_Mask66_g52212 * saturate( Interaction_Amplitude4351_g52212 ) ));
				float temp_output_3572_0_g52212 = saturate( VertexPosition3564_g52212.y );
				half Mesh_Motion_182_g52212 = temp_output_3572_0_g52212;
				float2 break143_g52212 = ( lerpResult109_g52212 * Mesh_Motion_182_g52212 );
				half Motion_Z190_g52212 = break143_g52212.y;
				half Angle44_g53462 = Motion_Z190_g52212;
				...
				half Motion_X216_g52212 = break143_g52212.x;
				half Angle44_g53465 = -Motion_X216_g52212;
				float3 Vertex_Motion_Object833_g52212 = ( VertexPosRotationAxis50_g53465 + ( VertexPosOtherAxis82_g53465 * cos( Angle44_g53465 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g53465 ) * sin( Angle44_g53465 ) ) );
				half Global_VertexTex_Size174_g52212 = break322_g53460.w;
				float lerpResult346_g52212 = lerp( 1.0 , Global_VertexTex_Size174_g52212 , _GlobalSize);
				float3 appendResult3480_g52212 = (float3(lerpResult346_g52212 , lerpResult346_g52212 , lerpResult346_g52212));
				half3 Vertex_Size1741_g52212 = appendResult3480_g52212;
				half3 _Vector5 = half3(1,1,1);
				float3 Vertex_SizeFade1740_g52212 = _Vector5;
				half IsInitialized3811_g52212 = _IsInitialized;
				float3 Final_VertexPosition890_g52212 = ( ( ( Vertex_Motion_Object833_g52212 * Vertex_Size1741_g52212 * Vertex_SizeFade1740_g52212 ) - VertexPosition3564_g52212 ) * IsInitialized3811_g52212 );
				...
				o.ase_texcoord8.w = 0;
				v.vertex.xyz += Final_VertexPosition890_g52212;
        	...
        	half4 frag (GraphVertexOutput IN, out float outDepth : SV_Depth ) : SV_Target
            {
				...
				half3 Main_Albedo_Raw4295_g52212 = o.Albedo;
				float dotResult4302_g52212 = dot( float3(0.2126,0.7152,0.0722) , Main_Albedo_Raw4295_g52212 );
				float3 temp_cast_0 = (dotResult4302_g52212).xxx;
				float4 break3589_g52212 = output0;
				half Main_Mask_Leaves3712_g52212 = ceil( break3589_g52212.g );
				float lerpResult4305_g52212 = lerp( _ImpostorBarkSaturationValue , _ImpostorLeafSaturationValue , Main_Mask_Leaves3712_g52212);
				float3 lerpResult4303_g52212 = lerp( temp_cast_0 , Main_Albedo_Raw4295_g52212 , lerpResult4305_g52212);
				float4 lerpResult4310_g52212 = lerp( _ImpostorBarkColor , _ImpostorLeafColor , Main_Mask_Leaves3712_g52212);
				float dotResult4323_g52212 = dot( float3(0.2126,0.7152,0.0722) , Main_Albedo_Raw4295_g52212 );
				float3 temp_cast_2 = (dotResult4323_g52212).xxx;
				float3 lerpResult4317_g52212 = lerp( temp_cast_2 , Main_Albedo_Raw4295_g52212 , _ImpostorGrassSaturationValue);
				#ifdef TVE_IS_GRASS_SHADER
				float3 staticSwitch4322_g52212 = ( lerpResult4317_g52212 * (_ImpostorGrassColor).rgb );
				#else
				float3 staticSwitch4322_g52212 = ( lerpResult4303_g52212 * (lerpResult4310_g52212).rgb );
				#endif
				half3 Main_Albedo3817_g52212 = staticSwitch4322_g52212;
				half3 Blend_Albedo4137_g52212 = Main_Albedo3817_g52212;
				float3 temp_cast_3 = (_NoiseScaleValue).xxx;
				float3 temp_output_3563_0_g52212 = worldPos;
				float3 World_Pos4027_g52212 = temp_output_3563_0_g52212;
				float temp_output_7_0_g53452 = _NoiseMinValue;
				half Noise_Mask4030_g52212 = saturate( ( ( tex3D( TVE_WorldTex3D, ( temp_cast_3 * World_Pos4027_g52212 * 0.1 ) ).r - temp_output_7_0_g53452 ) / ( _NoiseMaxValue - temp_output_7_0_g53452 ) ) );
				float4 lerpResult4044_g52212 = lerp( _NoiseColorTwo , _NoiseColorOne , Noise_Mask4030_g52212);
				half3 Noise_Tint4031_g52212 = (lerpResult4044_g52212).rgb;
				...
				half Global_NoiseTex_H2869_g52212 = pow( abs( tex2DNode75_g53468.a ) , lerpResult169_g53468 );
				float lerpResult376_g53478 = lerp( 0.1 , 1.0 , Wind_Power369_g53478);
				half Wind_Power_103106_g52212 = lerpResult376_g53478;
				float3 worldToObj3565_g52212 = mul( GetWorldToObjectMatrix(), float4( temp_output_3563_0_g52212, 1 ) ).xyz;
				float3 VertexPosition3564_g52212 = worldToObj3565_g52212;
				float temp_output_3572_0_g52212 = saturate( VertexPosition3564_g52212.y );
				half Mesh_Height1524_g52212 = temp_output_3572_0_g52212;
				half Main_Mask_Variation_Or_Metallic3607_g52212 = break3589_g52212.r;
				half3 Highlight_Tint3904_g52212 = ( ( (_MotionHighlightColor).rgb * Global_NoiseTex_H2869_g52212 * Wind_Power_103106_g52212 * Mesh_Height1524_g52212 * Main_Mask_Variation_Or_Metallic3607_g52212 ) + float3( 1,1,1 ) );
				#ifdef TVE_IS_GRASS_SHADER
				float3 staticSwitch4284_g52212 = Highlight_Tint3904_g52212;
				#else
				float3 staticSwitch4284_g52212 = _Vector10;
				#endif
				half3 Blend_AlbedoTinted3958_g52212 = ( Blend_Albedo4137_g52212 * Noise_Tint4031_g52212 * staticSwitch4284_g52212 );
				float dotResult4002_g52212 = dot( Blend_AlbedoTinted3958_g52212 , float3(0.2126,0.7152,0.0722) );
				float3 temp_cast_7 = (dotResult4002_g52212).xxx;
				float3 Position58_g53463 = World_Pos4027_g52212;
				...
				half Global_ColorsTex_A1701_g52212 = (lerpResult88_g53463).a;
				half Global_Colors_Influence3998_g52212 = Global_ColorsTex_A1701_g52212;
				float3 lerpResult4004_g52212 = lerp( Blend_AlbedoTinted3958_g52212 , temp_cast_7 , Global_Colors_Influence3998_g52212);
				half3 Global_ColorsTex_RGB1700_g52212 = (lerpResult88_g53463).rgb;
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g53450 = 2.0;
				#else
				float staticSwitch1_g53450 = 4.594794;
				#endif
				half3 Global_Colors3856_g52212 = ( Global_ColorsTex_RGB1700_g52212 * staticSwitch1_g53450 );
				float lerpResult4092_g52212 = lerp( 1.0 , Main_Mask_Variation_Or_Metallic3607_g52212 , _ColorsVariationValue);
				half Global_Colors_Value3999_g52212 = ( _GlobalColors * lerpResult4092_g52212 );
				half Main_Mask_Subsurface_Or_Blend3609_g52212 = break3589_g52212.b;
				#ifdef TVE_IS_GRASS_SHADER
				float staticSwitch4275_g52212 = ( 1.0 - Main_Mask_Subsurface_Or_Blend3609_g52212 );
				#else
				float staticSwitch4275_g52212 = Main_Mask_Subsurface_Or_Blend3609_g52212;
				#endif
				float temp_output_7_0_g53455 = _ColorsMaskMinValue;
				half Global_Colors_Mask4022_g52212 = ( saturate( ( ( staticSwitch4275_g52212 - temp_output_7_0_g53455 ) / ( _ColorsMaskMaxValue - temp_output_7_0_g53455 ) ) ) * Main_Mask_Leaves3712_g52212 );
				float3 lerpResult4007_g52212 = lerp( Blend_AlbedoTinted3958_g52212 , ( lerpResult4004_g52212 * Global_Colors3856_g52212 ) , ( Global_Colors_Value3999_g52212 * Global_Colors_Mask4022_g52212 ));
				float3 lerpResult4086_g52212 = lerp( Blend_Albedo4137_g52212 , lerpResult4007_g52212 , Main_Mask_Leaves3712_g52212);
				half3 Blend_AlbedoColored3711_g52212 = lerpResult4086_g52212;
				float3 temp_output_3681_0_g52212 = (_SubsurfaceColor).rgb;
				float dotResult4019_g52212 = dot( temp_output_3681_0_g52212 , float3(0.2126,0.7152,0.0722) );
				float3 temp_cast_10 = (dotResult4019_g52212).xxx;
				float3 lerpResult4018_g52212 = lerp( temp_output_3681_0_g52212 , temp_cast_10 , Global_Colors_Influence3998_g52212);
				float3 lerpResult4017_g52212 = lerp( temp_output_3681_0_g52212 , ( lerpResult4018_g52212 * Global_Colors3856_g52212 ) , ( Global_Colors_Value3999_g52212 * Global_Colors_Mask4022_g52212 ));
				half3 Subsurface_Color3656_g52212 = lerpResult4017_g52212;
				half MainLight_Subsurface4111_g52212 = TVE_MainLightParams.a;
				half Subsurface_Intensity3684_g52212 = ( _SubsurfaceValue * MainLight_Subsurface4111_g52212 );
				float temp_output_7_0_g53467 = _SubsurfaceMaskMinValue;
				half Subsurface_Mask3666_g52212 = ( saturate( ( ( Main_Mask_Subsurface_Or_Blend3609_g52212 - temp_output_7_0_g53467 ) / ( _SubsurfaceMaskMaxValue - temp_output_7_0_g53467 ) ) ) * Main_Mask_Leaves3712_g52212 );
				half3 Subsurface_Transmission3659_g52212 = ( Subsurface_Color3656_g52212 * Subsurface_Intensity3684_g52212 * Subsurface_Mask3666_g52212 );
				half3 MainLight_Direction4110_g52212 = TVE_MainLightDirection;
				float3 normalizeResult3635_g52212 = normalize( ( _WorldSpaceCameraPos - ase_worldPos ) );
				float dotResult3631_g52212 = dot( -MainLight_Direction4110_g52212 , normalizeResult3635_g52212 );
				float saferPower3620_g52212 = max( (dotResult3631_g52212*0.5 + 0.5) , 0.0001 );
				#ifdef UNITY_PASS_FORWARDADD
				float staticSwitch3636_g52212 = 0.0;
				#else
				float staticSwitch3636_g52212 = ( pow( saferPower3620_g52212 , _MainLightAngleValue ) * _MainLightScatteringValue );
				#endif
				half Mask_Subsurface_View3614_g52212 = staticSwitch3636_g52212;
				half3 World_Normal3638_g52212 = o.Normal;
				float dotResult3625_g52212 = dot( MainLight_Direction4110_g52212 , World_Normal3638_g52212 );
				float lerpResult4385_g52212 = lerp( 1.0 , saturate( dotResult3625_g52212 ) , _MainLightNormalValue);
				#ifdef TVE_IS_GRASS_SHADER
				float staticSwitch4387_g52212 = 1.0;
				#else
				float staticSwitch4387_g52212 = lerpResult4385_g52212;
				#endif
				#ifdef UNITY_PASS_FORWARDADD
				float staticSwitch3618_g52212 = 0.0;
				#else
				float staticSwitch3618_g52212 = staticSwitch4387_g52212;
				#endif
				half Mask_Subsurface_Normal3637_g52212 = staticSwitch3618_g52212;
				half3 Subsurface_Scattering3702_g52212 = ( Subsurface_Transmission3659_g52212 * Blend_AlbedoColored3711_g52212 * Mask_Subsurface_View3614_g52212 * Mask_Subsurface_Normal3637_g52212 );
				half3 Albedo_Subsurface3874_g52212 = ( Blend_AlbedoColored3711_g52212 + Subsurface_Scattering3702_g52212 );
				half3 Global_OverlayColor1758_g52212 = (TVE_OverlayColor).rgb;
				half Main_AlbedoTex_G3807_g52212 = Main_Albedo_Raw4295_g52212.y;
				float3 Position82_g53466 = World_Pos4027_g52212;
				...
				half Global_ExtrasTex_Overlay156_g52212 = break89_g53466.b;
				float temp_output_3774_0_g52212 = ( _GlobalOverlay * Global_ExtrasTex_Overlay156_g52212 );
				float lerpResult3746_g52212 = lerp( 1.0 , Main_Mask_Variation_Or_Metallic3607_g52212 , _OverlayVariationValue);
				half Overlay_Commons3739_g52212 = ( temp_output_3774_0_g52212 * lerpResult3746_g52212 );
				#ifdef TVE_IS_GRASS_SHADER
				float staticSwitch4267_g52212 = ( ( ( Main_Mask_Subsurface_Or_Blend3609_g52212 * 0.5 ) + Main_AlbedoTex_G3807_g52212 ) * Overlay_Commons3739_g52212 );
				#else
				float staticSwitch4267_g52212 = ( ( ( World_Normal3638_g52212.y * 0.5 ) + Main_AlbedoTex_G3807_g52212 ) * Overlay_Commons3739_g52212 );
				#endif
				float temp_output_7_0_g53457 = _OverlayMaskMinValue;
				half Overlay_Mask3762_g52212 = saturate( ( ( staticSwitch4267_g52212 - temp_output_7_0_g53457 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g53457 ) ) );
				float3 lerpResult3875_g52212 = lerp( Albedo_Subsurface3874_g52212 , Global_OverlayColor1758_g52212 , Overlay_Mask3762_g52212);
				half3 Final_Albedo4100_g52212 = lerpResult3875_g52212;
				half IsInitialized3811_g52212 = _IsInitialized;
				float3 lerpResult3815_g52212 = lerp( float3( 1,0,0 ) , Final_Albedo4100_g52212 , IsInitialized3811_g52212);
				float3 localLODFadeCustom3987_g52212 = ( lerpResult3815_g52212 );
				{
				...
				#ifdef LOD_FADE_CROSSFADE
				float3 staticSwitch3989_g52212 = localLODFadeCustom3987_g52212;
				#else
				float3 staticSwitch3989_g52212 = lerpResult3815_g52212;
				#endif
				
				float4 temp_output_4421_0_g52212 = ( _EmissiveColor * _EmissiveIntensityParams.x );
				half Global_ExtrasTex_Emissive4408_g52212 = break89_g53466.r;
				float lerpResult4417_g52212 = lerp( 1.0 , Global_ExtrasTex_Emissive4408_g52212 , _GlobalEmissive);
				half3 Final_Emissive4365_g52212 = ( (( temp_output_4421_0_g52212 * output1 )).rgb * lerpResult4417_g52212 );
				
				float3 temp_cast_14 = (( 0.04 * _RenderSpecular )).xxx;
				
				half Main_Mask_Smoothness3820_g52212 = break3589_g52212.a;
				half Main_Smoothness3838_g52212 = ( Main_Mask_Smoothness3820_g52212 * _ImpostorSmoothnessValue );
				half Global_ExtrasTex_Wetness305_g52212 = break89_g53466.g;
				float lerpResult3892_g52212 = lerp( Main_Smoothness3838_g52212 , saturate( ( Main_Smoothness3838_g52212 + Global_ExtrasTex_Wetness305_g52212 ) ) , _GlobalWetness);
				half Final_Smoothness3898_g52212 = lerpResult3892_g52212;
				
				float temp_output_3577_0_g52212 = o.Alpha;
				float localCustomAlphaClipAlways4430_g52212 = ( temp_output_3577_0_g52212 );
				float lerpResult4049_g52212 = lerp( 0.9 , (Main_Mask_Variation_Or_Metallic3607_g52212*0.5 + 0.5) , _AlphaVariationValue);
				half Global_ExtrasTex_Alpha1033_g52212 = break89_g53466.a;
				float lerpResult4053_g52212 = lerp( 1.0 , ( ( lerpResult4049_g52212 - ( 1.0 - Global_ExtrasTex_Alpha1033_g52212 ) ) + 0.1 ) , _GlobalAlpha);
				float lerpResult4075_g52212 = lerp( 1.0 , saturate( lerpResult4053_g52212 ) , Main_Mask_Leaves3712_g52212);
				half Final_Alpha4102_g52212 = lerpResult4075_g52212;
				float Alpha4430_g52212 = Final_Alpha4102_g52212;
				{
				clip(Alpha4430_g52212 - 0.1);
				}
				
				
		        float3 Albedo = staticSwitch3989_g52212;
				float3 Normal = World_Normal3638_g52212;
				float3 Emission = Final_Emissive4365_g52212;
				float3 Specular = temp_cast_14;
				float Metallic = 0;
				float Smoothness = Final_Smoothness3898_g52212;
				float Occlusion = 1;
				float3 Transmission = 1;
				float3 Translucency = 1;
				float Alpha = localCustomAlphaClipAlways4430_g52212;
        ...
        Pass
        {
            ...
            VertexOutput vert(GraphVertexInput v)
            {
				...
				float3 vertexValue = Final_VertexPosition890_g52212;
...
Node;AmplifyShaderEditor.FunctionNode;319;-1664,512;Inherit;False;Define IS SHADER TYPE;-1;;53483;90bdd02d483309144a404aee7f41383d;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;326;-576,-768;Inherit;False;Compile All Shaders;-1;;53485;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=D5C653A94ABE1E1B59F5746759E5DC114B7E9E4F
