    ...
    SubShader
    {
        ...
        Pass
        {
        	...
        	half4 frag (GraphVertexOutput IN, out float outDepth : SV_Depth ) : SV_Target
            {
				...
				float dotResult4326_g53398 = dot( float3(0.2126,0.7152,0.0722) , Main_Albedo_Raw4295_g53398 );
				float3 temp_cast_0 = (dotResult4326_g53398).xxx;
				float3 lerpResult4294_g53398 = lerp( temp_cast_0 , Main_Albedo_Raw4295_g53398 , _ImpostorPropSaturationValue);
				half3 Main_Albedo3817_g53398 = ( lerpResult4294_g53398 * (_ImpostorPropColor).rgb );
				float3 temp_output_3563_0_g53398 = worldPos;
				float3 World_Pos4027_g53398 = temp_output_3563_0_g53398;
				half2 Second_UVs4286_g53398 = ( ( (World_Pos4027_g53398).xz * (_SecondUVs).xy ) + (_SecondUVs).zw );
				half3 Second_Albedo4241_g53398 = (( tex2D( _SecondAlbedoTex, Second_UVs4286_g53398 ) * _SecondColor )).rgb;
				...
				float lerpResult4185_g53398 = lerp( World_Normal3638_g53398.y , -World_Normal3638_g53398.y , _DetailProjectionMode);
				half Blend_Source4135_g53398 = ( lerpResult4185_g53398 + _DetailMeshValue );
				...
				half Mask_Detail4138_g53398 = saturate( ( ( saturate( ( Blend_Source4135_g53398 + ( Blend_Source4135_g53398 * Main_Mask_Subsurface_Or_Blend3609_g53398 ) ) ) - temp_output_7_0_g53454 ) / ( _DetailBlendMaxValue - temp_output_7_0_g53454 ) ) );
				float3 lerpResult4207_g53398 = lerp( Main_Albedo3817_g53398 , ( Main_Albedo3817_g53398 * Second_Albedo4241_g53398 * staticSwitch1_g53459 ) , Mask_Detail4138_g53398);
				float3 lerpResult4214_g53398 = lerp( Main_Albedo3817_g53398 , Second_Albedo4241_g53398 , Mask_Detail4138_g53398);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float3 staticSwitch4153_g53398 = lerpResult4207_g53398;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float3 staticSwitch4153_g53398 = lerpResult4214_g53398;
				#else
				float3 staticSwitch4153_g53398 = lerpResult4207_g53398;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float3 staticSwitch4189_g53398 = Main_Albedo3817_g53398;
				#elif defined(TVE_DETAIL_MODE_ON)
				float3 staticSwitch4189_g53398 = staticSwitch4153_g53398;
				#else
				float3 staticSwitch4189_g53398 = Main_Albedo3817_g53398;
				#endif
				half3 Blend_Albedo4137_g53398 = staticSwitch4189_g53398;
				float3 _Vector10 = float3(1,1,1);
				half3 Blend_AlbedoTinted3958_g53398 = ( Blend_Albedo4137_g53398 * float3(1,1,1) * _Vector10 );
				half Main_Mask_Leaves3712_g53398 = ceil( break3589_g53398.g );
				float3 lerpResult4086_g53398 = lerp( Blend_Albedo4137_g53398 , Blend_AlbedoTinted3958_g53398 , Main_Mask_Leaves3712_g53398);
				half3 Blend_AlbedoColored3711_g53398 = lerpResult4086_g53398;
				half3 Albedo_Subsurface3874_g53398 = Blend_AlbedoColored3711_g53398;
				...
				half Overlay_Commons3739_g53398 = temp_output_3774_0_g53398;
				...
				half Final_Metallic3834_g53398 = ( Main_Mask_Variation_Or_Metallic3607_g53398 * _ImpostorMetallicValue );
				...
				float Metallic = Final_Metallic3834_g53398;
				float Smoothness = Final_Smoothness3898_g53398;
				float Occlusion = 1;
				float3 Transmission = 1;
				float3 Translucency = 1;
				float Alpha = temp_output_3577_0_g53398;
...
Node;AmplifyShaderEditor.FunctionNode;323;-1408,512;Inherit;False;Define FEATURES UNIVERSAL AI;-1;;53486;ba69d246da7a8ba47a16a174259c237e;0;0;1;FLOAT;529
Node;AmplifyShaderEditor.FunctionNode;321;-768,-768;Inherit;False;Compile Impostors;-1;;53485;1cfd52e266bd86c47a094d0358cb5b93;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;306;-1664,512;Inherit;False;Define SHADER OBJECT;-1;;53484;1237b3cc9fbfe714d8343c91216dc9b4;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;108;-1408,-768;Half;False;Property;_IsObjectsShader;_IsObjectsShader;140;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;1;1;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=5DAFE8D42EB6906176BA727FA2E1FAD144602956
